...
# ------------------------------------------------------------------ FILES
DIRECT_XLSX  = "final3modelstranslation_semantic_analysis.xlsx"   # gold + 3 direct LLMs
HYBRID_XLSX  = "chunkfinalthree_model_evaluation_250.xlsx"        # hybrid gold + 3 hybrid outputs
GOOGLE_CSV   = "baseline_google_translations.csv"                 # col: google_english
INDIC_CSV    = "baseline_indictrans2_translations.csv"            # col: indictrans2_english
